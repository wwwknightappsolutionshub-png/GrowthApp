    ...
    <div className="mx-auto flex min-h-dvh max-w-lg flex-col">
      ...
      {!hideNav ? (
        <nav className="fixed bottom-0 left-0 right-0 z-10 border-t border-slate-200 bg-white">
          <div className="mx-auto flex max-w-lg justify-center px-2 py-2">
            <Link
              href={rewardsPath(tenant, 'dashboard')}
              className={clsx(
                'flex flex-col items-center gap-0.5 rounded-lg px-6 py-1.5 text-[10px] font-medium',
