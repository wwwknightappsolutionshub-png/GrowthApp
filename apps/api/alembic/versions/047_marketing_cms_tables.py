...
def upgrade() -> None:
    ...
    if not _table_exists(inspector, "marketing_sections"):
        op.create_table(
            "marketing_sections",
    ...
    elif not _index_exists(inspector, "marketing_sections", op.f("ix_marketing_sections_key")):
        op.create_index(op.f("ix_marketing_sections_key"), "marketing_sections", ["key"], unique=True)

    if not _table_exists(inspector, "marketing_reviews"):
        op.create_table(
            "marketing_reviews",
            sa.Column("id", UUIDType(), nullable=False),
    ...
    elif not _index_exists(inspector, "marketing_reviews", op.f("ix_marketing_reviews_status")):
        op.create_index(op.f("ix_marketing_reviews_status"), "marketing_reviews", ["status"], unique=False)

    if not _table_exists(inspector, "landing_page_templates"):
        op.create_table(
        ...
        if not _index_exists(inspector, "landing_page_templates", op.f("ix_landing_page_templates_slug")):
            op.create_index(
                op.f("ix_landing_page_templates_slug"), "landing_page_templates", ["slug"], unique=True
            )
        if not _index_exists(inspector, "landing_page_templates", op.f("ix_landing_page_templates_niche")):
            op.create_index(
                op.f("ix_landing_page_templates_niche"), "landing_page_templates", ["niche"], unique=False
            )
...
def downgrade() -> None:
    ...
    if _table_exists(inspector, "landing_page_templates"):
        if _index_exists(inspector, "landing_page_templates", op.f("ix_landing_page_templates_niche")):
            op.drop_index(op.f("ix_landing_page_templates_niche"), table_name="landing_page_templates")
        if _index_exists(inspector, "landing_page_templates", op.f("ix_landing_page_templates_slug")):
            op.drop_index(op.f("ix_landing_page_templates_slug"), table_name="landing_page_templates")
        op.drop_table("landing_page_templates")
    if _table_exists(inspector, "marketing_reviews"):
        if _index_exists(inspector, "marketing_reviews", op.f("ix_marketing_reviews_status")):
            op.drop_index(op.f("ix_marketing_reviews_status"), table_name="marketing_reviews")
        op.drop_table("marketing_reviews")
    if _table_exists(inspector, "marketing_sections"):
        if _index_exists(inspector, "marketing_sections", op.f("ix_marketing_sections_key")):
